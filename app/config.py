...
=====================================================
GTX 1080 Ti (11GB VRAM, Pascal) + i7-9700K + 32GB RAM

ARQUITECTURA INVERTIDA:
- Pesos del modelo -> RAM (32 GB)
- KV Cache (contexto) -> VRAM (11 GB, bloqueado)
...
# Flash Attention: reduce uso de VRAM y acelera atencion en Pascal/GTX 1080 Ti
os.environ["OLLAMA_FLASH_ATTENTION"] = "1"

# Desactivar TF32 (no soportado en Pascal)
